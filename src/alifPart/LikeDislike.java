            ...
            case 1:                
                ...
                if(LoggedIn.loggedIn() !=0){
                    ...
                    if(checkLiked(userId, videoId) == 0 && checkDisliked(userId, videoId) == 0) {
                        ...
                        // new
                        insertUserHistory(userId, videoId, 1, 0);
            ...
            case 2:
                ...
                if(LoggedIn.loggedIn() !=0){                
                    ...
                    if(checkLiked(userId, videoId) == 0 && checkDisliked(userId, videoId) == 0) {
                        ...
                        // new
                        insertUserHistory(userId, videoId, 0, 1);
...
//            System.out.println("Update video successful");
     ...
     */
    private static void updateLikedDislikedBoolean(int userId, int videoId, int likedBoolean, int dislikedBoolean) throws SQLException{
        Connection con = getConnection();
...
//            System.out.println("Update user_history successful");
    ...
    /**
     * UPDATE FIELDS liked/disliked in TABLE user_history
     */
    private static void insertUserHistory(int userId, int videoId, int liked, int disliked) throws SQLException {
        Connection con = getConnection();
        
        try(PreparedStatement posted = con.prepareStatement(
                "INSERT INTO user_history(user_id, video_id, liked, disliked) VALUES('"+userId+"', '"+videoId+"', '"+liked+"', '"+disliked+"')"))
        {
            posted.executeUpdate();
